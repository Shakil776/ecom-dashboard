...
<head>
  ...
  <style>
    ...
    background-color: #fff;border: 1px solid #aaa; border-radius: 4px; height: 40px !important;}
  </style>
@section('css')
  <!-- Select2 -->
...
<div class="wrapper" id="app">
  ...
  <!-- Navbar -->
  @include('layouts.admin_layouts.includes.header')
  <!-- /.navbar -->
  <!-- Main Sidebar Container -->
  @include('layouts.admin_layouts.includes.sidebar')
  <!-- Content Wrapper. Contains page content -->
  @yield('main-content')
  <!-- /.content-wrapper -->
  @include('layouts.admin_layouts.includes.footer')
  <!-- Control Sidebar -->
