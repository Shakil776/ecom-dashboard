      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Store Brand</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          @endif
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Store Brand</h3>
                <div>
                    <a href="{{ route('brand.create') }}" class="btn btn-small btn-info float-right"><i class="fas fa-plus"></i>&nbsp;Add Brand</a>
                </div>
              </div>
