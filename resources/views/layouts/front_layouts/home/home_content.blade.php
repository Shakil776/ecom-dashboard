                                        ...
                                        <li class="span3">
                                            <div class="thumbnail">
                                                ...
                                                <a href="{{ url('product/' . $item['id']) }}">
                                                    ...
                                                    @else
                                                        <img src="{{ asset('images/product_images/small/no-image.png') }}"
                                                            alt="Product Image">
                                                    @endif
                                                </a>
                                                <div class="caption">
                                                    <h5><a href="{{ url('product/' . $item['id']) }}"
                                                    ...
                                                    <h6>
                                                        ...
                                                        <span class="pull-right">
                                                            @if ($discounted_price > 0)
                                                                <span
                                                                    style="color: red;"><del>TK.&nbsp;{{ $item['product_price'] }}</del></span>
                                                                TK.&nbsp;{{ $discounted_price }}
                                                            @else
            ...
            @foreach ($newProducts as $product)
                <li class="span3">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h5><a href="{{ url('product/' . $product['id']) }}"
                                    style="text-decoration: none;">{{ $product['product_name'] }}</a></h5>
                            <p>
